...
import { ProjectSectionCenteredTextComponent } from './project-section/project-section-centered-text.component';
import { ProjectSectionCenteredQuoteComponent } from './project-section/project-section-centered-quote.component';
import { ProjectSectionCenteredImageComponent } from './project-section/project-section-centered-image.component';
...
export * from './project-section/project-section-centered-quote.component';
export * from './project-section/project-section-centered-image.component';
